...
#define PACKAGE_STRING "PostgreSQL 8.0.7"
...
#define PG_VERSION_STR "PostgreSQL 8.0.7 on i686-pc-cygwin, compiled by GCC gcc (GCC) 3.4.4 (cygming special) (gdc 0.12, using dmd 0.125)"
