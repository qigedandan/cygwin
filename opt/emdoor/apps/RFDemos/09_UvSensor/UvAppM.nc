//=============================================================================
//	Document:		UvAppM.nc
//	Description:	模组文件，用于提供紫外线传感器节点的驱动程序组件
//	Date:			2011/04/17
//	Author:			Paul.Jia
//	Copyright:		Emdoor
//=============================================================================
...
implementation
{
	...
	{
		error_t result;
		result = call SensorCollection.startSensor(p_sensor_payload,SENSOR_ID_UV);
		if(result != SUCCESS)
		{	
			ADBG(1000, "\r\n !!!!sensor data error\r\n");
			post sensorDataTask();
	...
	task void sendMsgTask() 
	{
       ...
       {/* get length of total payload */
		...
		call AMPacket.setGroup(&m_sensor_msg, SENSOR_ID_UV);
