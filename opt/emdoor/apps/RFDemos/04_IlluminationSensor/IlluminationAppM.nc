//=============================================================================
//	Document:		IlluminationAppM.nc
//	Description:	模组文件，用于提供光照传感器节点的驱动程序组件
//	Date:			2011/04/17
//	Author:			Paul.Jia
//	Copyright:		Emdoor
//=============================================================================
...
implementation
{
	...
	//uint8_t m_sensor_type = SENSOR_ID_ILLUMINATION;
	...
	task void sendMsgTask() 
	{
       ...
       {/* get length of total payload */
		...
		call AMPacket.setGroup(&m_sensor_msg, SENSOR_ID_ILLUMINATION);
