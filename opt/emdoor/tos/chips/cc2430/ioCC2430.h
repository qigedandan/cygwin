...
#define NESC_NOP  _nop_()


#define DELAY_1US_12T_12M NESC_NOP;

//#define DELAY_1US_12T_6M { NESC_NOP; }

#define DELAY_1US_6T_6M   NESC_NOP;

#define DELAY_1US_6T_12M  NESC_NOP; NESC_NOP;

#define DELAY_1US_1T_32M    {uint8_t i=32;  while (i--); }


///////////////////
#define DELAY_1US       DELAY_1US_1T_32M
...
uint8_t volatile S0CON      __attribute((sfrAT0x98));   /*  S0CON            */
...
uint8_t volatile IEN0    __attribute((sfrAT0xA8)); /* Also known as IE */
uint8_t volatile EAL    __attribute((sbitAT0xA8)); /* EAL Interrupt Enable */
...
uint8_t volatile IRCON __attribute((sfrAT0xC0)); /* Interrupt Flags 4           */
...
norace uint8_t volatile U1BUF  __attribute((sfrAT0xF9)); /*  USART 0 Rx/Tx Data Buffer        */
uint8_t volatile U1CSR __attribute((sfrAT0xF8)); /*  USART 0 Control and Status   */
uint8_t volatile U1UCR  __attribute((sfrAT0xFB)); /*  USART 0 UART Control                    */
uint8_t volatile U1GCR  __attribute((sfrAT0xFC)); /*  USART 0 Generic Control                 */
uint8_t volatile U1BAUD __attribute((sfrAT0xFA)); /*  USART 0 Baud Rate Control               */
...
typedef uint16_t uint16_t_data;   // will be replaced by uint16_t data
typedef uint8_t uint8_t_data;     // will be replaced by uint8_t data
...
/* PM0 XDATA 0xE000-0xEFFF, will lose data when enter PM2/PM3, so often used this as temporary variables  */
typedef uint32_t uint32_t_xdata_pm0;   // will be replaced by uint32_t xdata(PM0:0xE000-0xEFFF)
typedef uint16_t uint16_t_xdata_pm0;   // will be replaced by uint16_t xdata(PM0:0xE000-0xEFFF)
typedef uint8_t uint8_t_xdata_pm0;     // will be replaced by uint8_t xdata(PM0:0xE000-0xEFFF)
...
#define _CC2430_RSSI       _XIO16( 0xDF06 ) /* RSSI and CCA Status and Control          */
...
#define _CC2430_FSMTC      _XIO16( 0xDF20 ) /* Finite State Machine Time Constants     */
...
#define _CC2430_MANAND     _XIO16( 0xDF22 ) /* Manual Signal AND Override             */
...
#define _CC2430_MANOR      _XIO16( 0xDF24 ) /* Manual Signal OR Override               */
...
#define _CC2430_AGCCTRL    _XIO16( 0xDF26 ) /* AGC Control                             */
...
#define _CC2430_X_U0BUF   _XIO8( 0xDFC1 ) 	/* XDATA U0BUF      */

#define UQ_ALARM_MILLI "HilAlarmMILLIC.Alarm"
#define UQ_ALARM_32KHZ "HilAlarm32khzC.Alarm"
#define UQ_ALARM_MICRO "HilAlarmMicroC.Alarm"
