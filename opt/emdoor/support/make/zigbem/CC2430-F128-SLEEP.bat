...
SET LINKOBJECT="startup.obj","app.obj","pm0.obj"
...
@C:\Keil\C51\BIN\C51.EXE "pm0.c" LARGE OMF2 PRINT(.\pm0.lst) OBJECT(.\pm0.obj) WARNINGLEVEL (0) 

echo Linking all files to binary
@C:\Keil\C51\BIN\LX51.EXE %LINKOBJECT% TO "app" PRINT (app.map) CLASSES( XDATA(X:0xF000-X:0xFD53), XDATA_PM0(X:0xE000-X:0xEFFF), IDATA(I:0-I:0xFF)) REGFILE(app.reg) DISABLEWARNING (15) 
